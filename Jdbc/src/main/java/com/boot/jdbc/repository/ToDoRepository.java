...
public class ToDoRepository implements CommonRepository<ToDo> {
    ...
    private static final String SQL_UPDATE =
            "update todo set description =:description, modified = :modified, " +
    ...
    public ToDo findById(String id) {
        try {
            Map<String, String> namedParameters = Collections.
                    singletonMap("id", id);
            return this.namedParameterJdbcTemplate.queryForObject(SQL_QUERY_FIND_BY_ID,
    ...
    public Iterable<ToDo> findAll() {
        return this.namedParameterJdbcTemplate.query(SQL_QUERY_FIND_ALL, toDoRowMapper);
    }
}